---
title: "Видеонаблюдение на даче своими руками: как настроить без интернета"
slug: "videonablyudenie-na-dache-svoimi-rukami"
seo_title: "Видеонаблюдение на даче своими руками без интернета"
seo_description: "Как настроить видеонаблюдение на даче своими руками: Wi-Fi, 4G или GSM-камера, работа без интернета, расчёт трафика. Пошаговая инструкция и калькулятор."
focus_keyword: "видеонаблюдение на даче своими руками"
...
status: draft
images:
  - images/videonablyudenie-na-dache-svoimi-rukami.jpg
  - images/videonablyudenie-na-dache-svoimi-rukami-2.jpg
  - images/videonablyudenie-na-dache-svoimi-rukami-3.jpg
  - images/videonablyudenie-na-dache-svoimi-rukami-4.jpg
  - images/videonablyudenie-na-dache-svoimi-rukami-5.jpg
  - images/videonablyudenie-na-dache-svoimi-rukami-6.jpg
---
...
![Камера видеонаблюдения на фасаде дачного дома под навесом крыши](images/videonablyudenie-na-dache-svoimi-rukami.jpg)
...
- **Wi-Fi-камера** — работает через домашний роутер, видео пишется в облако
  ...
  постоянного интернета на участке — та же зависимость, из-за которой
  на морозе и при слабой сети отваливаются умные розетки; разбор их
  минусов — в статье [«Умная розетка для дачи»](https://mir-doma.pro/umnaya-rozetka-dlya-dachi/).
...
- **GSM-камера** — упрощённый вариант: шлёт SMS или MMS с фото при
  ...
  Похожим образом устроена и
  [GSM-сигнализация для дачи](https://mir-doma.pro/gsm-signalizaciya-dlya-dachi-svoimi-rukami/) —
  только вместо камеры на дверях и окнах стоят датчики открытия и движения.
...
![4G-камера видеонаблюдения на столбе забора рядом с солнечной панелью](images/videonablyudenie-na-dache-svoimi-rukami-2.jpg)

## Видеонаблюдение без интернета: как это работает

![SIM-карта в слоте 4G-камеры видеонаблюдения крупным планом](images/videonablyudenie-na-dache-svoimi-rukami-3.jpg)
...
![Камера видеонаблюдения крупным планом с инфракрасной подсветкой на кронштейне](images/videonablyudenie-na-dache-svoimi-rukami-4.jpg)
...
![Монтаж кронштейна камеры видеонаблюдения на деревянной стене дома](images/videonablyudenie-na-dache-svoimi-rukami-5.jpg)
...
<!-- wp:html -->
<div id="mdVnCalc" class="md-vn">
<div class="md-vn__head">
<h3 class="md-vn__title">Калькулятор трафика 4G-камеры</h3>
<p class="md-vn__sub">Оценка усреднённая — реальный расход зависит от кодека (H.264/H.265) и сложности сцены в кадре.</p>
</div>
<div class="md-vn__grid">
<label class="md-vn__f"><span>Разрешение видео</span>
<select id="vnRes">
...
<label class="md-vn__f"><span>Часов записи в сутки</span><input type="number" id="vnHours" value="3" min="0.1" max="24" step="0.1"></label>
<label class="md-vn__f"><span>Дней в месяце</span><input type="number" id="vnDays" value="30" min="1" max="31" step="1"></label>
</div>
<p class="md-vn__note">Для записи только по движению обычно набегает 1–4 часа реального видео в сутки. Для непрерывной записи 24/7 поставьте 24 часа.</p>
<div class="md-vn__res">
<div class="md-vn__resitem"><span>Трафик в сутки</span><b id="vnDay">0,8 ГБ</b></div>
<div class="md-vn__resitem"><span>Трафик в месяц</span><b id="vnMonth">24,7 ГБ</b></div>
<div class="md-vn__resitem"><span>Нужен тариф</span><b id="vnTariff">—</b></div>
</div>
<div class="md-vn__actions">
...
<p id="vnStatus" class="md-vn__status"></p>
</div>
<style>
.md-vn{--vn-g:#2f6f9e;--vn-bd:#e2e2e2;--vn-bg:#f5f9fb;--vn-vk:#0077ff;--vn-tg:#26a5e4;max-width:760px;margin:28px auto;padding:20px;border:1px solid var(--vn-bd);border-radius:14px;background:#fff;font-family:inherit;color:#222;line-height:1.5;box-sizing:border-box}
.md-vn *{box-sizing:border-box}
.md-vn__title{margin:0 0 6px;font-size:1.3em;color:var(--vn-g)}
.md-vn__sub{margin:0 0 16px;font-size:.9em;color:#666}
.md-vn__grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(200px,1fr));gap:12px;margin-bottom:10px}
.md-vn__f{display:flex;flex-direction:column;gap:5px;font-size:.88em;font-weight:600;color:#444}
.md-vn__f input,.md-vn__f select{padding:10px 12px;border:1px solid var(--vn-bd);border-radius:9px;font-size:16px;font-family:inherit;font-weight:400;background:#fafafa;width:100%}
.md-vn__f input:focus,.md-vn__f select:focus{outline:none;border-color:var(--vn-g);background:#fff}
.md-vn__note{margin:0 0 16px;font-size:.83em;color:#888;font-style:italic}
.md-vn__res{display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px;padding:14px;background:var(--vn-bg);border-radius:10px;margin-bottom:10px}
.md-vn__resitem{text-align:center}
.md-vn__resitem span{display:block;font-size:.8em;color:#666;margin-bottom:3px}
.md-vn__resitem b{font-size:1.15em;color:var(--vn-g)}
.md-vn__actions{display:flex;gap:9px;margin-top:10px;flex-wrap:wrap}
.md-vn__btn{flex:1 1 auto;min-width:130px;padding:12px 16px;border:1px solid var(--vn-g);border-radius:9px;background:#fff;color:var(--vn-g);font-size:.95em;font-family:inherit;font-weight:600;cursor:pointer;text-align:center;text-decoration:none;display:inline-block}
.md-vn__btn--main{background:var(--vn-g);color:#fff}
.md-vn__btn--vk{border-color:var(--vn-vk);color:var(--vn-vk)}
.md-vn__btn--tg{border-color:var(--vn-tg);color:var(--vn-tg)}
.md-vn__btn:active{opacity:.7}
.md-vn__status{margin:10px 0 0;font-size:.87em;color:var(--vn-g);min-height:1.2em;text-align:center}
@media (max-width:600px){.md-vn{padding:15px;border-radius:11px}.md-vn__grid{grid-template-columns:1fr}}
@media print{.md-vn__actions,.md-vn__status,.md-vn__sub{display:none}.md-vn{border:none;max-width:100%}}
</style>
<script>
(function(){
...
function calc(){
 var mbps=parseFloat($('vnRes').value)||2;
 var hours=parseFloat($('vnHours').value)||0;
 var days=parseFloat($('vnDays').value)||30;
 var MBps=mbps/8;
 var mbPerDay=MBps*3600*hours;
 var gbPerDay=mbPerDay/1024;
 var gbPerMonth=gbPerDay*days;
 var tariff;
 if(gbPerMonth<=5) tariff='от 5 ГБ (минимальный IoT-тариф)';
 else if(gbPerMonth<=15) tariff='от 15 ГБ';
 else if(gbPerMonth<=30) tariff='от 30 ГБ';
 else tariff='безлимитный тариф для видеонаблюдения';
 $('vnDay').textContent=nf(gbPerDay,2)+' ГБ';
 $('vnMonth').textContent=nf(gbPerMonth,1)+' ГБ';
 $('vnTariff').textContent=tariff;
 return {gbPerDay:gbPerDay,gbPerMonth:gbPerMonth,tariff:tariff,hours:hours,mbps:mbps};
}
function shortText(){
 var d=calc();
 return 'Камера '+d.mbps*8+'Мбит, '+d.hours+' ч записи в сутки — трафик ≈'+nf(d.gbPerMonth,1)+' ГБ/мес, нужен тариф '+d.tariff+'. Расчёт: mir-doma.pro/videonablyudenie-na-dache-svoimi-rukami/';
}
function updateShareLinks(){
 var url=location.href.split('#')[0];
 var text=shortText();
 $('vnVk').href='https://vk.com/share.php?url='+encodeURIComponent(url)+'&title='+encodeURIComponent('Расчёт трафика 4G-камеры')+'&description='+encodeURIComponent(text);
 $('vnTg').href='https://t.me/share/url?url='+encodeURIComponent(url)+'&text='+encodeURIComponent(text);
}
function recalc(){ calc(); updateShareLinks(); }
['vnRes','vnHours','vnDays'].forEach(function(id){
 var el=$(id); el.addEventListener('input',recalc); el.addEventListener('change',recalc);
});
function flash(msg){$('vnStatus').textContent=msg;setTimeout(function(){$('vnStatus').textContent='';},2600);}
$('vnCopy').addEventListener('click',function(){
 var t=shortText();
...
if(navigator.share){
 $('vnShareNative').hidden=false;
 $('vnShareNative').addEventListener('click',function(){
  navigator.share({title:'Расчёт трафика 4G-камеры',text:shortText(),url:location.href.split('#')[0]}).catch(function(){});
 });
}
$('vnPrint').addEventListener('click',function(){window.print();});
recalc();
})();
</script>
<!-- /wp:html -->
...
![Забор и калитка участка в кадре камеры видеонаблюдения](images/videonablyudenie-na-dache-svoimi-rukami-6.jpg)
