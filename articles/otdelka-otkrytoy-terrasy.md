---
title: "Отделка открытой террасы: чем обшить стены и потолок под открытым небом"
slug: "otdelka-otkrytoy-terrasy"
seo_title: "Отделка открытой террасы: чем обшить стены и потолок"
seo_description: "Чем обшить стены и потолок открытой террасы: материалы, которые выдержат дождь, солнце и мороз. Расчёт материала с запасом и калькулятор."
focus_keyword: "отделка открытой террасы"
...
images:
  ...
  - images/otdelka-otkrytoy-terrasy-3.jpg
  - images/otdelka-otkrytoy-terrasy-4.jpg
  - images/otdelka-otkrytoy-terrasy-5.jpg
  - images/otdelka-otkrytoy-terrasy-6.jpg
---
...
![Открытая терраса с деревянной обшивкой стен и потолка](images/otdelka-otkrytoy-terrasy.jpg)
...
там другой набор материалов и другая логика утепления.
...
<!-- wp:html -->
<div id="mdOtCalc" class="md-ot">
<div class="md-ot__head">
<h3 class="md-ot__title">Калькулятор материала для обшивки открытой террасы</h3>
<p class="md-ot__sub">Считает площадь с запасом на подрезку и число досок планкена или декинга.</p>
</div>
<div class="md-ot__grid">
<label class="md-ot__f"><span>Площадь стен под обшивку, м²</span><input type="number" id="otWalls" value="12" min="0" max="500" step="0.1"></label>
<label class="md-ot__f"><span>Площадь потолка под обшивку, м²</span><input type="number" id="otCeil" value="8" min="0" max="500" step="0.1"></label>
<label class="md-ot__f"><span>Способ монтажа</span>
<select id="otMount">
...
<label class="md-ot__f"><span>Длина доски, м</span><input type="number" id="otLen" value="3" min="0.5" max="6" step="0.1"></label>
<label class="md-ot__f"><span>Ширина доски, мм</span><input type="number" id="otWid" value="100" min="30" max="300" step="1"></label>
<label class="md-ot__f"><span>Цена за 1 м² материала, ₽ (необязательно)</span><input type="number" id="otPrice" value="" min="0" max="50000" step="1" placeholder="0"></label>
</div>
<div class="md-ot__res">
<div class="md-ot__resitem"><span>Площадь без запаса</span><b id="otAreaRaw">20,0 м²</b></div>
<div class="md-ot__resitem"><span>Площадь с запасом</span><b id="otAreaFin">22,0 м²</b></div>
<div class="md-ot__resitem"><span>Досок нужно</span><b id="otBoards">74 шт</b></div>
<div class="md-ot__resitem" id="otCostWrap" hidden><span>Стоимость материала</span><b id="otCost">—</b></div>
</div>
<p class="md-ot__note">Число досок округлено вверх. Крепёж (кляймеры, саморезы) и пропитку считайте отдельно по факту выбранного материала.</p>
<div class="md-ot__actions">
...
<p id="otStatus" class="md-ot__status"></p>
</div>
<style>
.md-ot{--ot-g:#3d7a3d;--ot-bd:#e2e2e2;--ot-bg:#f7faf7;--ot-vk:#0077ff;--ot-tg:#26a5e4;max-width:760px;margin:28px auto;padding:20px;border:1px solid var(--ot-bd);border-radius:14px;background:#fff;font-family:inherit;color:#222;line-height:1.5;box-sizing:border-box}
.md-ot *{box-sizing:border-box}
.md-ot__title{margin:0 0 6px;font-size:1.3em;color:var(--ot-g)}
.md-ot__sub{margin:0 0 16px;font-size:.9em;color:#666}
.md-ot__grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:12px;margin-bottom:16px}
.md-ot__f{display:flex;flex-direction:column;gap:5px;font-size:.88em;font-weight:600;color:#444}
.md-ot__f input,.md-ot__f select{padding:10px 12px;border:1px solid var(--ot-bd);border-radius:9px;font-size:16px;font-family:inherit;font-weight:400;background:#fafafa;width:100%}
.md-ot__f input:focus,.md-ot__f select:focus{outline:none;border-color:var(--ot-g);background:#fff}
.md-ot__res{display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px;padding:14px;background:var(--ot-bg);border-radius:10px;margin-bottom:10px}
.md-ot__resitem{text-align:center}
.md-ot__resitem span{display:block;font-size:.8em;color:#666;margin-bottom:3px}
.md-ot__resitem b{font-size:1.15em;color:var(--ot-g)}
.md-ot__note{margin:0 0 6px;font-size:.83em;color:#888;font-style:italic}
.md-ot__actions{display:flex;gap:9px;margin-top:10px;flex-wrap:wrap}
.md-ot__btn{flex:1 1 auto;min-width:130px;padding:12px 16px;border:1px solid var(--ot-g);border-radius:9px;background:#fff;color:var(--ot-g);font-size:.95em;font-family:inherit;font-weight:600;cursor:pointer;text-align:center;text-decoration:none;display:inline-block}
.md-ot__btn--main{background:var(--ot-g);color:#fff}
.md-ot__btn--vk{border-color:var(--ot-vk);color:var(--ot-vk)}
.md-ot__btn--tg{border-color:var(--ot-tg);color:var(--ot-tg)}
.md-ot__btn:active{opacity:.7}
.md-ot__status{margin:10px 0 0;font-size:.87em;color:var(--ot-g);min-height:1.2em;text-align:center}
@media (max-width:600px){.md-ot{padding:15px;border-radius:11px}.md-ot__grid{grid-template-columns:1fr}}
@media print{.md-ot__actions,.md-ot__status,.md-ot__sub{display:none}.md-ot{border:none;max-width:100%}}
</style>
<script>
(function(){
...
function calc(){
 var walls=parseFloat($('otWalls').value)||0, ceil=parseFloat($('otCeil').value)||0;
 var totalRaw=walls+ceil;
 var pct=parseFloat($('otMount').value)||0;
 var totalFin=totalRaw*(1+pct/100);
 var len=parseFloat($('otLen').value)||3, wid=parseFloat($('otWid').value)||100;
 var boardArea=len*(wid/1000);
 var boards=boardArea>0?Math.ceil(totalFin/boardArea):0;
 var price=parseFloat($('otPrice').value)||0;
 var cost=price>0?totalFin*price:0;
 $('otAreaRaw').textContent=nf(totalRaw)+' м²';
 $('otAreaFin').textContent=nf(totalFin)+' м²';
 $('otBoards').textContent=boards+' шт';
 $('otCostWrap').hidden=!(cost>0);
 if(cost>0) $('otCost').textContent=nf(cost,0)+' ₽';
 return {totalRaw:totalRaw,totalFin:totalFin,boards:boards,cost:cost,pct:pct};
}
function shortText(){
 var d=calc();
 var t='Обшивка террасы: '+nf(d.totalFin)+' м² с запасом '+d.pct+'% — '+d.boards+' досок';
 if(d.cost>0) t+=', ≈'+nf(d.cost,0)+' ₽';
 t+='. Расчёт: mir-doma.pro/otdelka-otkrytoy-terrasy/';
 return t;
}
function report(){
 var d=calc();
 var t='РАСЧЁТ МАТЕРИАЛА ДЛЯ ОБШИВКИ ОТКРЫТОЙ ТЕРРАСЫ\n';
 t+='Площадь без запаса: '+nf(d.totalRaw)+' м²\n';
 t+='Запас на подрезку: '+d.pct+'%\n';
 t+='Площадь с запасом: '+nf(d.totalFin)+' м²\n';
 t+='Досок нужно: '+d.boards+' шт\n';
 if(d.cost>0) t+='Стоимость материала: '+nf(d.cost,0)+' ₽\n';
 t+='\nИсточник: mir-doma.pro/otdelka-otkrytoy-terrasy/';
 return t;
}
function updateShareLinks(){
 var url=location.href.split('#')[0];
 var text=shortText();
 $('otVk').href='https://vk.com/share.php?url='+encodeURIComponent(url)+'&title='+encodeURIComponent('Расчёт обшивки открытой террасы')+'&description='+encodeURIComponent(text);
 $('otTg').href='https://t.me/share/url?url='+encodeURIComponent(url)+'&text='+encodeURIComponent(text);
}
function recalc(){ calc(); updateShareLinks(); }
['otWalls','otCeil','otMount','otLen','otWid','otPrice'].forEach(function(id){
 var el=$(id); el.addEventListener('input',recalc); el.addEventListener('change',recalc);
});
function flash(msg){$('otStatus').textContent=msg;setTimeout(function(){$('otStatus').textContent='';},2600);}
$('otCopy').addEventListener('click',function(){
 var t=report();
...
if(navigator.share){
 $('otShareNative').hidden=false;
 $('otShareNative').addEventListener('click',function(){
  navigator.share({title:'Расчёт обшивки открытой террасы',text:shortText(),url:location.href.split('#')[0]}).catch(function(){});
 });
}
$('otPrint').addEventListener('click',function(){window.print();});
recalc();
})();
</script>
<!-- /wp:html -->

![Крепление планкена на открытой террасе скрытым крепежом](images/otdelka-otkrytoy-terrasy-2.jpg)
...
![Обшивка потолка открытой террасы вагонкой из термодерева](images/otdelka-otkrytoy-terrasy-3.jpg)
...
![Готовая отделка стен открытой террасы декингом](images/otdelka-otkrytoy-terrasy-4.jpg)
...
![Открытая терраса с ограждением и обшивкой из декинга](images/otdelka-otkrytoy-terrasy-5.jpg)

![Общий вид отделанной открытой террасы под навесом](images/otdelka-otkrytoy-terrasy-6.jpg)
