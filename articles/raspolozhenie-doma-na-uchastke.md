...
Свобода выбора ограничена нормами. Основные отступы для жилого дома:

| От чего | Минимальный отступ |
|---|---|
| Красная линия улицы | 5 м |
| Красная линия проезда | 3 м |
| Граница с соседями (забор) | 3 м |
| Соседский дом (каменный + каменный) | 6 м |
| Соседский дом (каменный + деревянный) | 8 м |
| Соседский дом (деревянный + деревянный) | 10–15 м |
| Хозпостройки, гараж — от забора | 1 м |
| Постройки для птицы и скота — от забора | 4 м |

Нормы различаются по регионам и уставам СНТ и периодически меняются, поэтому перед стройкой их обязательно уточняют. Подробный разбор всех расстояний, включая санитарные (до колодца, септика, компоста), — в отдельной статье про [расстояние от дома до бани, забора и построек](https://mir-doma.pro/rasstoyanie-ot-doma-do-bani-zabora/).
...
## 🧭 Схема ориентации: что куда выходит

Чтобы не держать в голове, вот сводка по сторонам света:

| Сторона | Что размещать | Почему |
|---|---|---|
| **Юг** | Гостиная, детская, веранда, терраса | Максимум солнца весь день |
| **Восток** | Спальня, кухня | Мягкое утреннее солнце |
| **Запад** | Гостиная, столовая, зона отдыха | Вечернее солнце после работы |
| **Север** | Санузел, кладовая, котельная, гараж, лестница, тамбур | Солнце не нужно, помещения буферные |

**Как это ложится на участок:** дом ставят ближе к северной границе — тогда его тень падает на соседский проезд и хозяйственную зону, а не на ваш огород. Грядки и теплицу размещают **к югу от дома**, зону отдыха — с запада или юго-запада, хозблок и компост — с севера, в тени.
