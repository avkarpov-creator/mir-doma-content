---
title: "Фундамент под баню своими руками: какой тип выбрать и как рассчитать бетон"
slug: "fundament-pod-banyu-svoimi-rukami"
seo_title: "Фундамент под баню своими руками: выбор и расчёт"
seo_description: "Какой фундамент выбрать под баню: свайный, столбчатый или ленточный. Глубина заложения, гидроизоляция и слив, расчёт объёма бетона своими руками."
focus_keyword: "фундамент под баню своими руками"
...
status: draft
images:
  - images/fundament-pod-banyu-svoimi-rukami.jpg
  - images/fundament-pod-banyu-svoimi-rukami-2.jpg
  - images/fundament-pod-banyu-svoimi-rukami-3.jpg
  - images/fundament-pod-banyu-svoimi-rukami-4.jpg
  - images/fundament-pod-banyu-svoimi-rukami-5.jpg
  - images/fundament-pod-banyu-svoimi-rukami-6.jpg
---
...
![Заливка ленточного фундамента под баню](images/fundament-pod-banyu-svoimi-rukami.jpg)
...
![Свайно-винтовой фундамент под каркасную баню](images/fundament-pod-banyu-svoimi-rukami-2.jpg)
...
<!-- wp:html -->
<div id="mdFbCalc" class="md-fb">
<div class="md-fb__head">
<h3 class="md-fb__title">Калькулятор бетона на ленточный фундамент бани</h3>
<p class="md-fb__sub">Для свайного или столбчатого фундамента расчёт другой — считайте по объёму отдельных свай/столбов.</p>
</div>
<div class="md-fb__grid">
<label class="md-fb__f"><span>Периметр ленты (с учётом внутренних перегородок), м</span><input type="number" id="fbPer" value="20" min="2" max="300" step="0.1"></label>
<label class="md-fb__f"><span>Ширина ленты, м</span><input type="number" id="fbW" value="0.3" min="0.1" max="1" step="0.05"></label>
<label class="md-fb__f"><span>Высота ленты, м</span><input type="number" id="fbH" value="0.5" min="0.1" max="2" step="0.05"></label>
<label class="md-fb__f"><span>Запас на неровности, %</span><input type="number" id="fbRes" value="8" min="0" max="30" step="1"></label>
<label class="md-fb__f"><span>Цена за 1 м³ бетона, ₽ (необязательно)</span><input type="number" id="fbPrice" value="" min="0" max="100000" step="1" placeholder="0"></label>
</div>
<div class="md-fb__res">
<div class="md-fb__resitem"><span>Объём бетона</span><b id="fbVol">3,0 м³</b></div>
<div class="md-fb__resitem"><span>С запасом</span><b id="fbVolRes">3,2 м³</b></div>
<div class="md-fb__resitem" id="fbCostWrap" hidden><span>Стоимость</span><b id="fbCost">—</b></div>
</div>
<p class="md-fb__note">Если фундамент имеет сложную форму с перегородками, суммируйте периметр внешних стен и всех внутренних лент.</p>
<div class="md-fb__actions">
...
<p id="fbStatus" class="md-fb__status"></p>
</div>
<style>
.md-fb{--fb-g:#5a6a8a;--fb-bd:#e2e2e2;--fb-bg:#f6f7fb;--fb-vk:#0077ff;--fb-tg:#26a5e4;max-width:760px;margin:28px auto;padding:20px;border:1px solid var(--fb-bd);border-radius:14px;background:#fff;font-family:inherit;color:#222;line-height:1.5;box-sizing:border-box}
.md-fb *{box-sizing:border-box}
.md-fb__title{margin:0 0 6px;font-size:1.3em;color:var(--fb-g)}
.md-fb__sub{margin:0 0 16px;font-size:.9em;color:#666}
.md-fb__grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(230px,1fr));gap:12px;margin-bottom:16px}
.md-fb__f{display:flex;flex-direction:column;gap:5px;font-size:.88em;font-weight:600;color:#444}
.md-fb__f input{padding:10px 12px;border:1px solid var(--fb-bd);border-radius:9px;font-size:16px;font-family:inherit;font-weight:400;background:#fafafa;width:100%}
.md-fb__f input:focus{outline:none;border-color:var(--fb-g);background:#fff}
.md-fb__res{display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px;padding:14px;background:var(--fb-bg);border-radius:10px;margin-bottom:10px}
.md-fb__resitem{text-align:center}
.md-fb__resitem span{display:block;font-size:.8em;color:#666;margin-bottom:3px}
.md-fb__resitem b{font-size:1.15em;color:var(--fb-g)}
.md-fb__note{margin:0 0 6px;font-size:.83em;color:#888;font-style:italic}
.md-fb__actions{display:flex;gap:9px;margin-top:10px;flex-wrap:wrap}
.md-fb__btn{flex:1 1 auto;min-width:130px;padding:12px 16px;border:1px solid var(--fb-g);border-radius:9px;background:#fff;color:var(--fb-g);font-size:.95em;font-family:inherit;font-weight:600;cursor:pointer;text-align:center;text-decoration:none;display:inline-block}
.md-fb__btn--main{background:var(--fb-g);color:#fff}
.md-fb__btn--vk{border-color:var(--fb-vk);color:var(--fb-vk)}
.md-fb__btn--tg{border-color:var(--fb-tg);color:var(--fb-tg)}
.md-fb__btn:active{opacity:.7}
.md-fb__status{margin:10px 0 0;font-size:.87em;color:var(--fb-g);min-height:1.2em;text-align:center}
@media (max-width:600px){.md-fb{padding:15px;border-radius:11px}.md-fb__grid{grid-template-columns:1fr}}
@media print{.md-fb__actions,.md-fb__status,.md-fb__sub{display:none}.md-fb{border:none;max-width:100%}}
</style>
<script>
(function(){
var $=function(id){return document.getElementById(id)};
function nf(x,d){d=(d===undefined)?2:d;return x.toFixed(d).replace('.',',')}
function calc(){
 var per=parseFloat($('fbPer').value)||0, w=parseFloat($('fbW').value)||0, h=parseFloat($('fbH').value)||0;
 var vol=per*w*h;
 var resPct=parseFloat($('fbRes').value)||0;
 var volRes=vol*(1+resPct/100);
 var price=parseFloat($('fbPrice').value)||0;
 var cost=price>0?volRes*price:0;
 $('fbVol').textContent=nf(vol)+' м³';
 $('fbVolRes').textContent=nf(volRes)+' м³';
 $('fbCostWrap').hidden=!(cost>0);
 if(cost>0) $('fbCost').textContent=nf(cost,0)+' ₽';
 return {per:per,w:w,h:h,vol:vol,volRes:volRes,cost:cost};
}
function shortText(){
 var d=calc();
 var t='Фундамент бани: периметр '+nf(d.per)+' м, лента '+nf(d.w)+'×'+nf(d.h)+' м — нужно '+nf(d.volRes)+' м³ бетона';
 if(d.cost>0) t+=', ≈'+nf(d.cost,0)+' ₽';
 t+='. Расчёт: mir-doma.pro/fundament-pod-banyu-svoimi-rukami/';
 return t;
}
function report(){
 var d=calc();
 var t='РАСЧЁТ БЕТОНА НА ФУНДАМЕНТ БАНИ\n';
 t+='Периметр ленты: '+nf(d.per)+' м · сечение '+nf(d.w)+' × '+nf(d.h)+' м\n\n';
 t+='Объём бетона: '+nf(d.vol)+' м³\n';
 t+='С запасом: '+nf(d.volRes)+' м³\n';
 if(d.cost>0) t+='Стоимость: '+nf(d.cost,0)+' ₽\n';
 t+='\nИсточник: mir-doma.pro/fundament-pod-banyu-svoimi-rukami/';
 return t;
}
function updateShareLinks(){
 var url=location.href.split('#')[0];
 var text=shortText();
 $('fbVk').href='https://vk.com/share.php?url='+encodeURIComponent(url)+'&title='+encodeURIComponent('Расчёт бетона на фундамент бани')+'&description='+encodeURIComponent(text);
 $('fbTg').href='https://t.me/share/url?url='+encodeURIComponent(url)+'&text='+encodeURIComponent(text);
}
function recalc(){ calc(); updateShareLinks(); }
['fbPer','fbW','fbH','fbRes','fbPrice'].forEach(function(id){
 var el=$(id); el.addEventListener('input',recalc); el.addEventListener('change',recalc);
});
function flash(msg){$('fbStatus').textContent=msg;setTimeout(function(){$('fbStatus').textContent='';},2600);}
...
if(navigator.share){
 $('fbShareNative').hidden=false;
 $('fbShareNative').addEventListener('click',function(){
  navigator.share({title:'Расчёт бетона на фундамент бани',text:shortText(),url:location.href.split('#')[0]}).catch(function(){});
 });
}
$('fbPrint').addEventListener('click',function(){window.print();});
recalc();
})();
</script>
<!-- /wp:html -->
...
![Гидроизоляция цоколя бани в зоне слива воды](images/fundament-pod-banyu-svoimi-rukami-3.jpg)

## Фундамент под печь: отдельно или вместе

Тяжёлую кирпичную или каменную печь-каменку весом от 500–700 кг ставят на собственный фундамент, отдельный от фундамента стен, — жёстко связывать их нельзя, потому что здание и печь оседают неравномерно, и такая связка со временем трескается. Лёгкие металлические печи весом до 150–200 кг можно ставить прямо на усиленный пол без отдельного фундамента — по инструкции конкретной модели печи. Электрическая печь весит ещё меньше и вопрос фундамента под неё обычно не встаёт вовсе, зато добавляется вопрос электролинии — сравнение дровяной и электрической печи по всем параметрам, включая монтаж, в статье [«Дровяная или электрическая печь для бани»](https://mir-doma.pro/drovyanaya-ili-elektricheskaya-pech-dlya-bani/). Как сварить дровяную печь самостоятельно из трубы или металла — в статье [печь для бани своими руками из металла](https://mir-doma.pro/pech-dlya-bani-iz-metalla/), а какие камни в неё засыпать и сколько — в статье [какие камни для банной печи](https://mir-doma.pro/kakie-kamni-dlya-bannoy-pechi/).

![Отдельный фундамент под кирпичную печь-каменку в бане](images/fundament-pod-banyu-svoimi-rukami-4.jpg)
...
![Опалубка и арматурный каркас ленточного фундамента бани](images/fundament-pod-banyu-svoimi-rukami-6.jpg)
...
![Готовый фундамент бани с продухами в цоколе](images/fundament-pod-banyu-svoimi-rukami-5.jpg)
