...
- Не вся дачная автоматика вообще требует электричества и приложений — форточка теплицы, например, открывается сама по себе от нагрева, без розетки и Wi-Fi: разбор устройства в статье [«Автоматическое проветривание теплицы»](https://mir-doma.pro/avtomaticheskoe-provetrivanie-teplicy/).
